...
public abstract class ProxyAutomobile {
	...
	/**
	 * Used to return the make and model of all the automobiles that has been created
	 * @return ArrayList of automobile names
	 */
	public ArrayList<String> getAutomobiles(){
		return fleet.getAutomobiles();
	}
	
	/**
	 * Used to get an Automobile object from the linked Hashmap
	 * @param name of the Automobile object
	 * @return Automobile object
	 */
	public Automobile getAutoByName(String name){
		return fleet.getAutoByName(name);
	}
